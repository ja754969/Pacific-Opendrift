...
for year_i in selected_year:
        # Boundary dates
        start_date = datetime(year_i, 1, 1, 0, 0, 0)
        end_date = datetime(year_i, 6, 30, 23, 59, 59)

        # Output filename: ugos
        out_name_u = f"CMEMS_ADT_u-current_Jan_to_Jun_{year_i}.nc"
        ...
        out_name_v = f"CMEMS_ADT_v-current_Jan_to_Jun_{year_i}.nc"
