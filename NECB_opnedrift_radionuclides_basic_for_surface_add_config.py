...
# o.add_reader([reader_ncfile_2000_1,reader_ncfile_2000_2,reader_ncfile_2001_1,reader_ncfile_2001_2],
...
# SEEDING
td=datetime(2000,5,1,0,0,0)   
time = datetime(td.year, td.month, td.day, 0)

# latseed= 18;   lonseed= 123.125 # NEC Branch(North Equatrial Current Branch)
latseed= 25.03;   lonseed= 122.24 # Pacific

ntraj=100 # number of trajectory
...
o.run(steps=60, time_step=timedelta(days=1), time_step_output=timedelta(days=1),outfile='./nc_output/NECB_opnedrift_radionuclides_output.nc')
# 
#%%
